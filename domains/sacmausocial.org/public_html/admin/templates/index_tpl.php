...
$(function () {
    $('#container').highcharts({
        ...
        subtitle: {
            text: 'Devetloper by : <a href="https://t2p.com.vn">T2P Co.,LTD</a>'
        },
        xAxis: {
            type: 'category',
            labels: {
...
<div class="widget">
   <div class="title"><h6>Chào mừng bạn đến với Administrator - HỆ THỐNG QUẢN TRỊ NỘI DUNG WEBSITE - Powered by <a href="https://t2p.com.vn" target="_blank"><span style="color:#f00;">Thiết kế website T2P</span></a></h6><div class="clear"></div></div>
   <p>Nếu bạn có thắc mắc trong quá trình sử dụng, xin vui lòng gởi mail về địa chỉ <strong><a href="mailto:t2p@t2p.com.vn">t2p@t2p.com.vn</a></strong></p>
