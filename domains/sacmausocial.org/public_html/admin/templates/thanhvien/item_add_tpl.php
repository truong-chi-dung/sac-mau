...
<form name="supplier" id="validate" class="form" action="index.php?com=thanhvien&act=save" method="post" enctype="multipart/form-data">	        
    <div class="widget">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <img src="<?=_upload_thanhvien.$item['photo']?>" onerror="src='images/no-avatar.png'" alt="NO PHOTO" height="50" width="50" class="avatar_thanhvien" />
                <?php if($item['photo']!=""){?>
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['nguoigt']?>" name="nguoigt" title="Nhập tên người giới thiệu" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
