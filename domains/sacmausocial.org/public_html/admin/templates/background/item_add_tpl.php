	...
	<div class="control_frm" style="margin-top:25px;">
	    <div class="bc">
	        <ul id="breadcrumbs" class="breadcrumbs">
	        	<li><a href="index.php?com=background&act=capnhat<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Cập nhật <?=$title_main?></span></a></li>
	        </ul>
	        <div class="clear"></div>
	    </div>
	</div> 
		...
		<div class="formRow">
			...
			<div class="formRight">
				...
				<div class="mt10">
					...
					<img src="<?=_upload_hinhanh.$item['photo']?>"  alt="NO PHOTO" height="100" />
				</div>				
			</div>
