...
<?php } ?>
	<?php if($_GET['type']=="duan" || $_GET['type']=="bietthu") { ?>
		<div class="formRow">
			<label>Vị trí</label>
			<div class="ck_editor">
                <textarea id="vitri" name="vitri"><?=@$item['vitri']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="ck_editor">
                <textarea id="matbang" name="matbang"><?=@$item['matbang']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="ck_editor">
                <textarea id="tienich" name="tienich"><?=@$item['tienich']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="ck_editor">
                <textarea id="tiendo" name="tiendo"><?=@$item['tiendo']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="ck_editor">
                <textarea id="thanhtoan" name="thanhtoan"><?=@$item['thanhtoan']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
	<?php } ?>
	<?php if($_GET['type']!="khachhang" && $_GET['type']!="album" && $_GET['type']!="lkweb" && $_GET['type']!="hotronhanh") { ?>
		<div class="formRow lang_hidden lang_vi active">
