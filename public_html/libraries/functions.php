...
function get_product($array,$class,$com){ 
	global $lang;
	?>
	<div class="product-all row"> 
	<?php 	foreach($array as $v){ ?>
		<div class="col-md-3 col-xs-6 col-sm-6 wow fadeIn <?=$class?>">
            <div class="product">
                <div class="hinh-product transition hover_sang1">
                    <a href="<?=$com?>/<?=$v['tenkhongdau']?>.htm"><img class="transition lazy" src="thumb/278x168/2/<?=_upload_product_l.$v['photo']?>" border="0" alt="<?=$v['h1']?>" /></a>
                    
                </div>  
                <div class="ten-product"><h3><a href="<?=$com?>/<?=$v['tenkhongdau']?>.htm"><?=$v["ten_".$lang];?></a></h3></div> 
                <div class="mota-product">    
                    <p><?=catchuoi($v["mota_".$lang],80);?></p>
                    <div class="gia-product"><font><?php if($v['giaban']==0) echo _lienhe; else echo number_format ($v['giaban'],0,",",".").' vnđ' ?></font></div>
                </div>
            </div>  
        </div>              
		<?php } ?>
...
function get_dichvu($array,$class,$com){ 
	global $lang;
	?>
...
function get_subslider($array,$class,$com){ 
	global $lang;
	?>
	<div class="subSlider"> 
	
		<img class="transition lazy absolute" src="<?=_upload_hinhanh_l.$array['photo']?>" border="0" alt="<?=$array['ten_'.$lang]?>" /> 
		<div class="mv">
			<div class="name"><?=$array['ten_'.$lang]?></div>
			<div class="desc"><?=$array['mota_'.$lang]?></div>
		</div>            
	
	</div>
<?php }
function get_product_owl($array,$class,$class_owl,$com){ 
	global $lang,$row_setting;
	?>
	<div class="owl-carousel owl-theme <?=$class_owl?>"> 
	<?php 	foreach($array as $v){ ?>
		<div class="item wow fadeIn <?=$class?>">
            <div class="product">
                <div class="hinh-product transition ">
                    <a href="<?=$com?>/<?=$v['tenkhongdau']?>.htm"><img class="transition" src="thumb/275x205/1/<?=_upload_product_l.$v['photo']?>" border="0" alt="<?=$v['ten_'.$lang]?>" /></a>
                    <div class="show-more">
                    	<a class="wishlist"><i class="fa fa-heart"></i></a>
                    	<?php if($row_setting['dathang'] == 1){ ?> 
                    	<a class="add-cart add_to_cart"><i class="fa fa-cart-arrow-down"></i></a>	
                    	<?php }else{ ?>
                    	<a class="add-cart no-active-order"><i class="fa fa-cart-arrow-down"></i></a>	
                    	<?php } ?>
                    </div>
                </div>  
                <div class="mota-product">
                    <div class="ten-product"><h3><a href="<?=$com?>/<?=$v['tenkhongdau']?>.htm"><?php echo $v["ten_".$lang] ?></a></h3></div> 
                    <div class="gia-product"><?=_gia?>: <font><?php if($v['giaban']==0) echo _lienhe; else echo number_format ($v['giaban'],0,",",".").' đ' ?></font></div>
                </div>
            </div>  
        </div>              
		<?php } ?>
...
<?php }
function get_news($array,$class,$com){ 
	global $lang;
	?>
    ...
    <?php  foreach($array as $k=>$v){ ?>
        <li class="col-md-6 col-sm-6 col-xs-12">
        	<div class="list-news wow fadeInUp" data-tab="tab-1" data-wow-offset="0" data-wow-duration="1">
		        <div class="row">
		            <div class="col-md-4 col-sm-5 col-xs-4 hinh-tintuc">
		                <a class="my_glass" href="<?=$com?>/<?=$v['tenkhongdau']?>.htm"><img class="lazy transition hinhanh" src="thumb/210x170/1/<?=_upload_baiviet_l.$v['photo']?>" alt="<?=$v['ten_'.$lang]?>" /></a>
		            </div>
		            <div class="col-md-12 col-sm-12 col-xs-12" style="float:none">
		                <h3><a href="<?=$com?>/<?=$v['tenkhongdau']?>.htm"><?=$v['ten_'.$lang]?></a></h3>
		                <p><?=catchuoi($v['mota_'.$lang],240)?></p>
		            </div>
		            <div class="clear"></div>
		        </div>
		    </div>
...
<?php }
function get_news_in($array,$class,$com){ 
	global $lang;
	?>
	<div class="row tintuc-all">
    <ul>
    <?php  foreach($array as $v){ ?>
        <li class="col-md-12 col-sm-12 col-xs-12">
        	<div class="list-news">
		        <div class="row">
		            <div class="col-md-2 col-sm-5 col-xs-4 hinh-tintuc  wow fadeInLeft">
		                <a class="my_glass" href="<?=$com?>/<?=$v['tenkhongdau']?>.htm"><img class="transition hinhanh" src="thumb/210x170/1/<?=_upload_baiviet_l.$v['photo']?>" alt="<?=$v['ten_'.$lang]?>" /></a>
		            </div>
...
<?php }
function active_menu($com){
	if($_GET['com']==$com) echo 'class="active2"'; else echo 'class="menu"';
}
function menu_con($array_c1,$table,$com){ 
	global $lang,$d;
	foreach($array_c1 as $v_c1){
	$d->reset();
    $sql="select ten_$lang,tenkhongdau,id from ".$table."_cat where hienthi=1 and id_list='".$v_c1['id']."' order by stt,id desc"; 
    $d->query($sql);    
    $array_c2=$d->result_array(); ?>
    <li class="li-child"><a href="<?=$com?>/<?=$v_c1['tenkhongdau']?>.html"><?=$v_c1['ten_'.$lang]?></a>
    	<ul class="ul-child-child">
    	<?php if(count($array_c2) > 0){
    		foreach($array_c2 as $v_c2){ 
    		$d->reset();
		    $sql="select ten_$lang,tenkhongdau,id from ".$table."_item where hienthi=1 and id_cat='".$v_c2['id']."' order by stt,id desc"; 
		    $d->query($sql);    
		    $array_c3=$d->result_array();
    	?>
    	
    		<li class="li-child-child"><a href="<?=$com?>/<?=$v_c1['tenkhongdau']?>/<?=$v_c2['tenkhongdau']?>.htm"><?=$v_c2['ten_'.$lang]?></a>
    			<ul class="ul-child-child-child">
    			<?php if(count($array_c3) > 0){
    			foreach($array_c3 as $v_c3){ ?>
    					<li class="li-child"><a href="<?=$com?>/<?=$v_c1['tenkhongdau']?>/<?=$v_c2['tenkhongdau']?>/<?=$v_c3['tenkhongdau']?>.html"><?=$v_c3['ten_'.$lang]?></a>
    					</li>
