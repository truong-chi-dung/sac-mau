...
?>
	...
	<?php if(count($rows_qctrai)>0){?>
    	<a href="<?=$rows_qcphai[0]['mota']?>" target="_blank"><img src="<?=_upload_hinhanh_l.$trai?>" width="159" /></a><br/>	
<?php }?>		
    </div>
	...
	<?php if(count($rows_qcphai)>0){?>
    	<a href="<?=$rows_qctrai[0]['mota']?>" target="_blank"><img src="<?=_upload_hinhanh_l.$phai?>" width="159" /></a><br/>          
    ...
    <script>
    document.write("<script type='text/javascript' language='javascript'>MainContentW = 1024;LeftBannerW = 159;RightBannerW = 159;LeftAdjust = 10;RightAdjust = -5;TopAdjust = 40;ShowAdDiv();window.onresize=ShowAdDiv;;<\/script>");
    </script>
