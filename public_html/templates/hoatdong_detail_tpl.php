<div id="">
    <div id="status"> </div>
    <div class="container">
        <h2 class="title-page"><?=$row_list['ten_'.$lang]?></h2> </div>
                        ...
                        <div class="newsOtherList">
                            <ul>
                            	<?php foreach($tintuc as $tinkhac){?>
	                                <li> <a href="<?=$_GET['com']?>/<?=$tinkhac['tenkhongdau']?>-<?=$tinkhac['id']?>.htm"><?=$tinkhac['ten_'.$lang]?><span class="date"><?=date('d/m/Y', $tinkhac['ngaytao']);?></span> </a> </li>
	                            <?php } ?>
                    ...
                    <div class="typicalList">
                        ...
                        <?php foreach($tinmoi as $k=>$v){?>
                          <div class="items hvr-curl-top-left">
                            <div class="col-xs-4">
                                <a class="img" href="<?=$com?>/<?=$v['tenkhongdau']?>-<?=$v['id']?>.html" title="<?=$v['ten_'.$lang]?>"> <img src="<?=_upload_baiviet_l.$v['photo']?>" alt="<?=$v['ten_'.$lang]?>" title="<?=$v['ten_'.$lang]?>"> </a>
                            </div>
