...
<form name="supplier" id="validate" class="form" action="index.php?com=setting&act=save&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
    ...
    <div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="Iframe bản đồ" class="tipS" name="toado"><?=@$item['toado']?></textarea>
			</div>
			<div class="clear"></div>
		</div>	
		<!--
		...
		<div class="formRow">
			<label>Zalo</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['twitter']?>" name="twitter" title="Nhập số zalo" class="tipS" />
			</div>
			<div class="clear"></div>
		</div> 
		...
		<div class="formRow lang_hidden lang_vi active">
			<label>Slogan</label>
			<div class="ck_editor">
                <textarea id="google" name="google"><?=@$item['google']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<!--
 ...
 -->
    ...
    <div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="Scriptcode" class="tipS" name="scriptcode"><?=@$item['scriptcode']?></textarea>
			</div>
			<div class="clear"></div>
		</div>	
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="Scriptcode body" class="tipS" name="scriptcode_body"><?=@$item['scriptcode_body']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
        <div class="formRow">
